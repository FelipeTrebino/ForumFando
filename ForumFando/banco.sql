...
create user visitante identified by '';
create user usuarioComum identified by '1234';

-- Priv. Visitante
grant select on site.topico to visitante;
grant insert on site.usuario to visitante;
grant select on site.usuario to visitante;

-- Priv. UsuarioComum
grant select,insert,delete,update on site.topico to usuarioComum;
grant select on site.usuario to usuarioComum;
grant update(nome,interesses,sexo,dataNascimento,senha) on site.usuario to usuarioComum;

-- Priv. ADM
grant select,insert,delete on site.topico to adm;
grant select,delete on site.usuario to adm;
grant update(nome,interesses,sexo,dataNascimento,senha,nivel) on site.usuario to adm;
grant update(fixo) on site.topico to adm;
...
use mysql;
select * from columns_priv dados;